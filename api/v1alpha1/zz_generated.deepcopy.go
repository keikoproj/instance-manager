...
func (in *ValidationOverrides) DeepCopyInto(out *ValidationOverrides) {
	*out = *in
	if in.scalingConfigurationOverride != nil {
		in, out := &in.scalingConfigurationOverride, &out.scalingConfigurationOverride
		*out = new(ScalingConfigurationType)
		**out = **in
	}
}
