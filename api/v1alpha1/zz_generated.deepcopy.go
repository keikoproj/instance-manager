...
func (in *TargetStatus) DeepCopyInto(out *TargetStatus) {
	*out = *in
	...
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]*UtilizationCondition, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(UtilizationCondition)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UtilizationCondition) DeepCopyInto(out *UtilizationCondition) {
	*out = *in
	in.LastHeartbeatTime.DeepCopyInto(&out.LastHeartbeatTime)
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UtilizationCondition.
func (in *UtilizationCondition) DeepCopy() *UtilizationCondition {
	if in == nil {
		return nil
	}
	out := new(UtilizationCondition)
