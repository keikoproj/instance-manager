...
type FakeInstanceGroups struct {
	Fake *FakeInstancemgrV1alpha1
	ns   string
}

var instancegroupsResource = v1alpha1.SchemeGroupVersion.WithResource("instancegroups")

var instancegroupsKind = v1alpha1.SchemeGroupVersion.WithKind("InstanceGroup")
...
func (c *FakeInstanceGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(instancegroupsResource, c.ns, name, opts), &v1alpha1.InstanceGroup{})
