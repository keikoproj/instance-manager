...
import (
	...
	scheme "github.com/keikoproj/instance-manager/client/clientset/versioned/scheme"
...
func newInstanceGroups(c *InstancemgrV1alpha1Client, namespace string) *instanceGroups {
